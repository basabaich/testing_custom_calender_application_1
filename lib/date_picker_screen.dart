...
class DatePickerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'Vanilla Calendar Flutter',
          style: TextStyle(fontSize: 16.0),
        ),
      ),
      body: Padding(
        padding: const EdgeInsets.fromLTRB(10.0, 4.0, 10.0, 2.5),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              buildTextField(
                  controller: meetingName, hint: 'Enter Meeting Name'),
              const SizedBox(
                height: 15,
              ),
              buildTextField(
                  controller: meetingLink, hint: 'Enter Meeting Link'),
              const SizedBox(
                height: 5,
              ),
              const Text(
